...
(goog.global = this),
  ...
  (goog.addDependency = function (e, o, t, r) {
    if (goog.DEPENDENCIES_ENABLED) {
      for (
        var g, n, i = e.replace(/\\/g, "/"), a = goog.dependencies_, s = 0;
        (g = o[s]);
        s++
      )
        (a.nameToPath[g] = i), (a.pathIsModule[i] = !!r);
      for (var l = 0; (n = t[l]); l++)
        i in a.requires || (a.requires[i] = {}), (a.requires[i][n] = !0);
    }
  }),
  ...
  goog.DEPENDENCIES_ENABLED &&
    ...
    (goog.isDeferredModule_ = function (e) {
      var o = goog.getPathFromDeps_(e);
      return (
        !(!o || !goog.dependencies_.pathIsModule[o]) &&
        goog.basePath + o in goog.dependencies_.deferred
      );
    }),
    ...
    (goog.writeScripts_ = function () {
      ...
      for (o = 0; o < t.length; o++) {
        if (!(e = t[o]))
          throw (
            ((goog.moduleLoaderState_ = i), Error("Undefined script input"))
          );
        g.pathIsModule[e]
          ? (!0, goog.importModule_(goog.basePath + e))
  ...
  (goog.retrieveAndExecModule_ = function (e) {
    if (!COMPILED) {
      ...
      goog.IS_OLD_IE_
        ? ((goog.dependencies_.deferred[o] = g), goog.queuedModules_.push(o))
        : t(e, g);
    }
  }),
    ...
    return (
      ...
      null != r &&
        (r instanceof Function
          ? r(g)
          : goog.defineClass.applyProperties_(g, r)),
      g
    );
  }),
  ...
  (goog.string.removeAt = function (e, o, t) {
    ...
    return (
      0 <= o &&
        o < e.length &&
        0 < t &&
        (r = e.substr(0, o) + e.substr(o + t, e.length - o - t)),
      r
    );
  }),
  ...
  (goog.string.padNumber = function (e, o, t) {
    var r = goog.isDef(t) ? e.toFixed(t) : String(e),
      g = r.indexOf(".");
    return (
      -1 == g && (g = r.length), goog.string.repeat("0", Math.max(0, o - g)) + r
    );
  }),
  ...
  (goog.array.indexOf =
    ...
    (goog.array.ASSUME_NATIVE_FUNCTIONS || goog.array.ARRAY_PROTOTYPE_.indexOf)
      ...
      : function (e, o, t) {
          ...
          for (var g = r; g < e.length; g++) if (g in e && e[g] === o) return g;
          return -1;
        }),
  (goog.array.lastIndexOf =
    ...
    (goog.array.ASSUME_NATIVE_FUNCTIONS ||
      ...
      : function (e, o, t) {
          var r = null == t ? e.length - 1 : t;
          if ((r < 0 && (r = Math.max(0, e.length + r)), goog.isString(e)))
            return goog.isString(o) && 1 == o.length ? e.lastIndexOf(o, r) : -1;
          for (var g = r; 0 <= g; g--) if (g in e && e[g] === o) return g;
          return -1;
        }),
  (goog.array.forEach =
    goog.NATIVE_ARRAY_PROTOTYPES &&
  ...
  (goog.array.binarySearch_ = function (e, o, t, r, g) {
    for (var n, i = 0, a = e.length; i < a; ) {
      var s,
        l = (i + a) >> 1;
      0 < (s = t ? o.call(g, e[l], l, e) : o(r, e[l]))
        ? (i = 1 + l)
        : ((a = l), (n = !s));
    }
    return n ? i : ~i;
  ...
  (goog.array.range = function (e, o, t) {
    ...
    if (0 < i) for (var a = g; a < n; a += i) r.push(a);
    else for (a = g; n < a; a += i) r.push(a);
    return r;
  }),
  ...
  (goog.labs.userAgent.platform.getVersion = function () {
    ...
    if (goog.labs.userAgent.platform.isWindows())
      ...
      o =
        (t = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/.exec(e)) &&
        t[1].replace(/_/g, ".");
  ...
  (goog.html.SafeStyle.fromConstant = function (e) {
    ...
    return 0 === o.length
      ...
      : (goog.html.SafeStyle.checkStyle_(o),
        goog.asserts.assert(
          goog.string.endsWith(o, ";"),
          "Last character of style string is not ';': " + o
        ),
        goog.asserts.assert(
          goog.string.contains(o, ":"),
    ...
    var o = "",
      t = function (e) {
        goog.isArray(e)
          ...
          : (o += goog.html.SafeStyle.unwrap(e));
      };
    return (
  ...
  (goog.html.SafeStyleSheet.concat = function (e) {
    var o = "",
      t = function (e) {
        goog.isArray(e)
          ? goog.array.forEach(e, t)
          : (o += goog.html.SafeStyleSheet.unwrap(e));
      };
    return (
      goog.array.forEach(arguments, t),
  ...
  (goog.html.SafeStyleSheet.fromConstant = function (e) {
    ...
    return 0 === o.length
      ...
      : (goog.asserts.assert(
          !goog.string.contains(o, "<"),
          "Forbidden '<' character in style sheet string: " + o
        ),
        goog.html.SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(
          o
        ));
  ...
  (goog.i18n.bidi.guardBracketInText = function (e, o) {
    var t = (void 0 === o ? goog.i18n.bidi.hasAnyRtl(e) : o)
  ...
  (goog.i18n.bidi.estimateDirection = function (e, o) {
    for (
      ...
      goog.i18n.bidi.startsWithRtl(a)
        ...
        ? r++
        : goog.i18n.bidi.hasNumeralsRe_.test(a) && (g = !0);
    }
    return 0 == r
      ? g
        ? goog.i18n.bidi.Dir.LTR
  ...
  (goog.html.SafeUrl.fromBlob = function (e) {
    var o = goog.html.SAFE_BLOB_TYPE_PATTERN_.test(e.type)
  ...
  (goog.html.SafeHtml.htmlEscape = function (e) {
    ...
    var o,
      t = null;
    return (
      e.implementsGoogI18nBidiDirectionalString && (t = e.getDirection()),
      (o = e.implementsGoogStringTypedString
        ? e.getTypedStringValue()
        : String(e)),
  ...
  (goog.html.SafeHtml.htmlEscapePreservingNewlines = function (e) {
    ...
    return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
      goog.string.newLineToBr(goog.html.SafeHtml.unwrap(o)),
      o.getDirection()
    );
  }),
  (goog.html.SafeHtml.htmlEscapePreservingNewlinesAndSpaces = function (e) {
    ...
    var o = goog.html.SafeHtml.htmlEscape(e);
    return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
      goog.string.whitespaceEscape(goog.html.SafeHtml.unwrap(o)),
      o.getDirection()
    );
  }),
  ...
  (goog.html.SafeHtml.createIframe = function (e, o, t, r) {
    ...
    var n = goog.html.SafeHtml.combineAttributes(g, { sandbox: "" }, t);
    return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(
      "iframe",
      n,
      r
  ...
  (goog.html.SafeHtml.createStyle = function (e, o) {
    ...
    var n = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
      r,
      goog.i18n.bidi.Dir.NEUTRAL
    );
    return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(
      ...
      n = function (e) {
        if (goog.isArray(e)) goog.array.forEach(e, n);
          ...
          r == goog.i18n.bidi.Dir.NEUTRAL
            ? (r = t)
            : t != goog.i18n.bidi.Dir.NEUTRAL && r != t && (r = null);
        }
      };
    return (
      goog.array.forEach(arguments, n),
  ...
  (goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse =
    function (e, o, t) {
      ...
      var a = t;
      if (
        (goog.isDefAndNotNull(a) ? goog.isArray(a) || (a = [a]) : (a = []),
      ...
      return (
        l &&
          (r = /^(ltr|rtl|auto)$/i.test(l) ? goog.i18n.bidi.Dir.NEUTRAL : null),
        goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(g, r)
      );
    }),
  ...
  (goog.dom.safe.openInWindow = function (e, o, t, r, g) {
    var n;
    return (
      (n = e instanceof goog.html.SafeUrl ? e : goog.html.SafeUrl.sanitize(e)),
      (o || window).open(
        goog.html.SafeUrl.unwrap(n),
  ...
  (goog.math.longestCommonSubsequence = function (t, e, o, r) {
    ...
    for (l = 1; l <= i; l++)
      for (u = 1; u <= a; u++)
        g(t[l - 1], e[u - 1])
          ? (s[l][u] = s[l - 1][u - 1] + 1)
          : (s[l][u] = Math.max(s[l - 1][u], s[l][u - 1]));
    var c = [];
    for (l = i, u = a; 0 < l && 0 < u; )
      g(t[l - 1], e[u - 1])
  ...
  (goog.dom.getRequiredElementHelper_ = function (e, o) {
    ...
    return (t = goog.asserts.assertElement(
      t,
  ...
  (goog.dom.getElementsByTagNameAndClass_ = function (e, o, t, r) {
    ...
    if (t) {
      ...
      for (s = {}, l = 0, u = 0; (c = a[u]); u++) {
        var d = c.className;
        "function" == typeof d.split &&
          goog.array.contains(d.split(/\s+/), t) &&
          (s[l++] = c);
      }
      return (s.length = l), s;
    }
    ...
    if (o) {
      ...
      if (goog.dom.isCss1CompatMode_(o) && g.scrollHeight)
        ...
        var i = g.scrollHeight,
          a = g.offsetHeight;
        g.clientHeight != a && ((i = r.scrollHeight), (a = r.offsetHeight)),
  ...
  (goog.dom.getDocumentScrollElement_ = function (e) {
    return e.scrollingElement
      ? e.scrollingElement
      : !goog.userAgent.WEBKIT && goog.dom.isCss1CompatMode_(e)
      ? e.documentElement
  ...
  (goog.dom.createDom_ = function (e, o) {
    ...
    if (
      ...
      var g = ["<", t];
      if (
        (r.name && g.push(' name="', goog.string.htmlEscape(r.name), '"'),
        r.type)
      ) {
...
(goog.dom.createTextNode = function (e) {
  ...
  (goog.dom.getParentElement = function (e) {
    ...
    if (
      ...
      !(
        ...
        e instanceof goog.global.SVGElement
      ) &&
      (o = e.parentElement)
    )
      return o;
  ...
  (goog.dom.compareNodeOrder = function (e, o) {
    ...
    if ("sourceIndex" in e || (e.parentNode && "sourceIndex" in e.parentNode)) {
      ...
      return g == n
        ...
        : (t ? e.sourceIndex : g.sourceIndex) -
          (r ? o.sourceIndex : n.sourceIndex);
    }
    var i,
      a,
      s = goog.dom.getOwnerDocument(e);
    return (
      (i = s.createRange()).selectNode(e),
      i.collapse(!0),
  ...
  (goog.dom.findCommonAncestor = function (e) {
    ...
    var a = null;
    for (o = 0; o < g; o++) {
      for (var s = r[0][o], l = 1; l < t; l++) if (s != r[l][o]) return a;
      a = s;
    }
    return a;
  }),
  ...
  (goog.dom.isFocusable = function (e) {
    var o;
    return (o = goog.dom.nativelySupportsFocus_(e)
      ? !e.disabled &&
        (!goog.dom.hasSpecifiedTabIndex_(e) || goog.dom.isTabIndexFocusable_(e))
      : goog.dom.isFocusableTabIndex(e)) && goog.userAgent.IE
      ? goog.dom.hasNonZeroBoundingRect_(e)
      : o;
  }),
  ...
  (goog.dom.hasNonZeroBoundingRect_ = function (e) {
    var o = goog.isFunction(e.getBoundingClientRect)
  ...
  (goog.Promise.prototype.cancelChild_ = function (e, o) {
    if (this.callbackEntries_) {
      for (
        ...
        n && (n.always || (t++, n.child == e && (r = n), !(r && 1 < t)));
        n = n.next
      )
        r || (g = n);
      r &&
  ...
  (goog.Disposable.getUndisposedObjects = function () {
    ...
    for (var o in goog.Disposable.instances_)
      goog.Disposable.instances_.hasOwnProperty(o) &&
        e.push(goog.Disposable.instances_[Number(o)]);
    return e;
  }),
  ...
  (goog.events.BrowserEvent.prototype.init = function (e, o) {
    ...
    r
      ? goog.userAgent.GECKO &&
        (goog.reflect.canAccessProperty(r, "nodeName") || (r = null))
      : t == goog.events.EventType.MOUSEOVER
      ? (r = e.fromElement)
      : t == goog.events.EventType.MOUSEOUT && (r = e.toElement),
  ...
  (goog.events.ListenerMap.prototype.remove = function (e, o, t, r) {
    ...
    return (
      ...
      0 == n.length && (delete this.listeners[g], this.typeCount_--),
      !0)
    );
  }),
  ...
  (goog.events.ListenerMap.prototype.getListener = function (e, o, t, r) {
    var g = this.listeners[e.toString()],
      n = -1;
    return (
      g && (n = goog.events.ListenerMap.findListenerIndex_(g, o, t, r)),
      -1 < n ? g[n] : null
    );
  }),
  ...
  (goog.events.listen_ = function (e, o, t, r, g, n) {
    ...
    a ||
      (e[goog.events.LISTENER_MAP_PROP_] = a = new goog.events.ListenerMap(e));
    var s = a.add(o, t, r, g, n);
    if (s.proxy) return s;
    var l = goog.events.getProxy();
    if ((((s.proxy = l).src = e), (l.listener = s), e.addEventListener))
  ...
  (goog.events.getProxy = function () {
    var t = goog.events.handleBrowserEvent_,
      r = goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT
        ? function (e) {
  ...
  (goog.events.unlistenByKey = function (e) {
    ...
    t.removeEventListener
      ? t.removeEventListener(r, g, o.capture)
      : t.detachEvent && t.detachEvent(goog.events.getOnString_(r), g),
    ...
    return (
      n
        ? (n.removeByKey(o),
          0 == n.getTypeCount() &&
            ((n.src = null), (t[goog.events.LISTENER_MAP_PROP_] = null)))
        : o.markAsRemoved(),
      !0
    );
  }),
  ...
  (goog.events.handleBrowserEvent_ = function (e, o) {
    ...
    if (
      ...
      if (!goog.events.isMarkedIeEvent_(t)) {
        ...
        for (
          var a = e.type, s = n.length - 1;
          !r.propagationStopped_ && 0 <= s;
          s--
        ) {
          r.currentTarget = n[s];
  ...
  (goog.events.EventTarget.dispatchEventInternal_ = function (e, o, t) {
    ...
    if (
      (o.propagationStopped_ ||
        ((i = (n = o.currentTarget = e).fireListeners(r, !0, o) && i),
  ...
  (goog.Timer.prototype.tick_ = function () {
    if (this.enabled) {
      ...
      if (0 < e && e < this.interval_ * goog.Timer.intervalScale)
        return void (this.timer_ = this.timerObject_.setTimeout(
          this.boundTick_,
          this.interval_ - e
        ));
      this.timer_ &&
    ...
    for (var r in e)
      if (Object.prototype.hasOwnProperty.call(e, r)) {
        ...
        "function" != typeof g &&
          ...
          o.push(":"),
          this.serializeInternal(
            this.replacer_ ? this.replacer_.call(e, r, g) : g,
            o
          ),
          (t = ","));
      }
          ...
          if (goog.isDef(e))
            if (goog.isNull(e)) s.push("NULL");
              ...
              if (n.contains(e)) s.push("*** reference loop detected ***");
                ...
                for (var i in (n.add(e), s.push("{"), e))
                  (!a && goog.isFunction(e[i])) ||
  ...
  (goog.debug.createViewSourceUrl_ = function (e) {
    ...
    return goog.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(
      ...
      "view-source:" + goog.html.SafeUrl.unwrap(o)
    );
  }),
...
(goog.debug.LogManager.getLoggers = function () {
  ...
  (goog.uri.utils.getHost = function (e) {
    ...
    return goog.uri.utils.buildFromEncodedParts(
      ...
      o[goog.uri.utils.ComponentIndex.USER_INFO],
  ...
  (goog.uri.utils.getPathAndAfter = function (e) {
    ...
    return goog.uri.utils.buildFromEncodedParts(
      ...
      null,
      null,
      o[goog.uri.utils.ComponentIndex.PATH],
      o[goog.uri.utils.ComponentIndex.QUERY_DATA],
      o[goog.uri.utils.ComponentIndex.FRAGMENT]
    );
  }),
  ...
  (goog.uri.utils.haveSameDomain = function (e, o) {
    ...
    return (
      t[goog.uri.utils.ComponentIndex.DOMAIN] ==
        r[goog.uri.utils.ComponentIndex.DOMAIN] &&
      t[goog.uri.utils.ComponentIndex.SCHEME] ==
        r[goog.uri.utils.ComponentIndex.SCHEME] &&
      t[goog.uri.utils.ComponentIndex.PORT] ==
        r[goog.uri.utils.ComponentIndex.PORT]
    );
  }),
  ...
  (goog.uri.utils.appendParam = function (e, o, t) {
    var r = [e, "&", o];
    return (
      goog.isDefAndNotNull(t) && r.push("=", goog.string.urlEncode(t)),
  ...
  (goog.uri.utils.findParam_ = function (e, o, t, r) {
    for (var g = o, n = t.length; 0 <= (g = e.indexOf(t, g)) && g < r; ) {
      ...
      if (
        ...
        if (
          !a ||
          a == goog.uri.utils.CharCode_.EQUAL ||
          a == goog.uri.utils.CharCode_.AMPERSAND ||
          a == goog.uri.utils.CharCode_.HASH
        )
          return g;
      }
      g += n + 1;
  ...
  (goog.net.XhrIo.send = function (e, o, t, r, g, n, i) {
    ...
    return (
      goog.net.XhrIo.sendInstances_.push(a),
  ...
  (goog.net.XhrIo.prototype.send = function (e, o, t, r) {
    ...
    !goog.array.contains(goog.net.XhrIo.METHODS_WITH_FORM_DATA, g) ||
      a ||
      s ||
      i.set(
  ...
  (goog.net.XhrIo.prototype.getResponseHeaders = function () {
    for (
      var e = {}, o = this.getAllResponseHeaders().split("\r\n"), t = 0;
      t < o.length;
      t++
    )
  ...
  (goog.Uri.prototype.toString = function () {
    ...
    var n = this.getPath();
    n &&
      (this.hasDomain() && "/" != n.charAt(0) && e.push("/"),
      e.push(
        goog.Uri.encodeSpecialChars_(
          n,
          "/" == n.charAt(0)
    ...
    return (
      a &&
        e.push(
          "#",
          goog.Uri.encodeSpecialChars_(a, goog.Uri.reDisallowedInFragment_)
        ),
      e.join("")
    );
  }),
  ...
  if (r) {
    ...
    goog.net.XhrIo.send(
      ...
      function (e) {
        e.target.isSuccess()
          ? o()
          : (setCachedService(null, null), _findWebService(WS_SVC_HOST, o, n));
      },
      "GET",
      void 0,
      void 0,
...
function syncCheckWebService(t, e) {
  ...
  var i = r || WS_START_PORT,
    a = g || WS_SVC_HOST,
    s = a === WS_SVC_HOST;
  checkServiceStatus(i, a)
    ? n(i, a)
    : s && checkServiceStatus(i, WS_SVC_HOST_LEGACY)
    ? n(i, WS_SVC_HOST_LEGACY)
...
(dymo.label.framework.Label.prototype._getObjectElements = function (e) {
  ...
  (dymo.label.framework.Label.prototype._setAddressObjectText = function (
    ...
    if (this.isDCDLabel()) {
      ...
      var i,
        a = dymo.xml.getElement(e, "StyledText"),
      ...
      for (var d = o.split("\n"), m = 0; m < d.length; m++) {
        ...
        var f = i;
        0 < u.length
          ? (f = m < u.length ? u[m] : u[u.length - 1])
          : 0 < s.length &&
            (f =
              m < s.length
                ? dymo.xml.getElement(s[m], "Font")
                : dymo.xml.getElement(s[s.length - 1], "Font"));
        var h = c;
  ...
  (dymo.label.framework.Label.prototype.setLabelLength = function (e) {
    ...
    return (
      dymo.xml.setElementText(dymo.xml.getElement(g, "Length"), r),
    ...
    if (
      ...
      Error.captureStackTrace(t, goog.async.Deferred),
        "string" == typeof t.stack &&
          (this.constructorStack_ = t.stack.replace(/^[^\n]*\n/, ""));
    }
  }),
  ...
  (goog.async.Deferred.prototype.fire_ = function () {
    ...
    for (
      ...
      if (a)
        try {
          ...
          goog.isDef(s) &&
            ((this.hadError_ = this.hadError_ && (s == o || this.isError(s))),
            (this.result_ = o = s)),
            (goog.Thenable.isImplementedBy(o) ||
              ("function" == typeof goog.global.Promise &&
                o instanceof goog.global.Promise)) &&
              ((e = !0), (this.blocked_ = !0));
        } catch (e) {
          (o = e),
            (this.hadError_ = !0),
    ...
    if (((this.result_ = o), e)) {
      ...
      o instanceof goog.async.Deferred
        ? (o.addCallbacks(l, u), (o.blocking_ = !0))
        : o.then(l, u);
    } else
      !goog.async.Deferred.STRICT_ERRORS ||
        !this.isError(o) ||
        o instanceof goog.async.Deferred.CanceledError ||
        (t = this.hadError_ = !0);
  ...
  (goog.async.Deferred.when = function (e, o, t) {
    return e instanceof goog.async.Deferred
      ? e.branch(!0).addCallback(o, t)
      : goog.async.Deferred.succeed(e).addCallback(o, t);
  }),
  ...
  (goog.net.jsloader.load = function (e, o) {
    var t = o || {},
      ...
      a = null,
      s = goog.isDefAndNotNull(t.timeout)
        ? t.timeout
  ...
  (goog.net.Jsonp.prototype.send = function (e, o, t, r) {
    ...
    return s.addErrback(l), { id_: n, deferred_: s };
  }),
  ...
  (goog.net.IframeIo.handleIncrementalData = function (e, o) {
    var t = goog.string.endsWith(e.name, goog.net.IframeIo.INNER_FRAME_SUFFIX)
        ? e.parent.name
        : e.name,
  ...
  (goog.net.IframeIo.prototype.send = function (e, o, t, r) {
    ...
    t && g.makeUnique(),
      goog.log.info(
        this.logger_,
        "Sending iframe request: " + g + " [" + n + "]"
      ),
      (this.form_ = goog.net.IframeIo.getForm_()),
      "GET" == n &&
        goog.net.IframeIo.addFormInputs_(this.form_, g.getQueryData()),
  ...
  (goog.net.IframeIo.prototype.sendFormInternal_ = function () {
    if (
      ...
      goog.log.fine(this.logger_, "Setting up iframes and cloning form"),
        this.appendIframe_();
      var e,
        o = this.iframeName_ + goog.net.IframeIo.INNER_FRAME_SUFFIX,
      ...
      for (g = 0, n = s.length; g < n; g++)
        for (
          var u = s[g].getElementsByTagName(goog.dom.TagName.OPTION),
  ...
  (goog.net.IframeIo.createIframeHtml_ = function (e) {
    ...
    return goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(
      ...
      '<body><iframe id="' + o + '" name="' + o + '"></iframe>'
    );
  }),
  ...
  (goog.net.IframeIo.prototype.createIframe_ = function () {
    ...
    (o.visibility = "hidden"),
      ...
      (o.display = "none"),
      goog.userAgent.WEBKIT
        ? (o.marginTop = o.marginLeft = "-10px")
        : ((o.position = "absolute"), (o.top = o.left = "-10px"));
  }),
  ...
  (dymo.uuid.uuid = (function () {
    for (var a = Array, s = new a(16), r = [], g = {}, e = 0; e < 256; e++)
      (r[e] = (e + 256).toString(16).substr(1).toUpperCase()), (g[r[e]] = e);
    function l(e) {
      var o = r,
        t = e;
      return (
  ...
  (dymo.label.framework.NetworkPrinterName.splitNetworkPrinterName = function (
    ...
    var o = new goog.Uri(e),
      t = o.getPath();
    return (
      1 < t.length && "/" == t.charAt(0) && (t = t.slice(1)),
      o.setPath(""),
...
function _createNsapiPlugin2(e) {
  ...
  if (!document.getElementById(o)) {
    ...
    (t.type = "application/x-dymolabel"),
      (t.id = o),
      e
        ? ((t.width = 1), (t.height = 1), (t.hidden = !0))
        : ((t.width = 0), (t.height = 0), (t.hidden = !1)),
  ...
  if (!document.getElementById(o)) {
    ...
    (t.type = "application/x-npapi-dymolabel"),
      ...
      e
        ...
        : ((t.width = 0), (t.height = 0), (t.hidden = !1)),
      document.body.appendChild(t),
      t.getPrinters || ((t.width = 1), (t.height = 1), (t.hidden = !1));
  }
  return document.getElementById(o);
}
...
(dymo.label.framework.PrintJobStatusInfo = function (e, o, t, r) {
  ...
  (dymo.label.framework.PrintJobStatusInfo.parse = function (e) {
    var o = {},
      t = e.split(" ");
    return (
      1 <= t.length && (o.status = parseInt(t[0], 10)),
  ...
  (dymo.label.framework.chooseEnvironment = function (e) {
    ...
    if (e.isWebServicePresent) {
      ...
      return (o = {
        ...
        getJobStatus: function (e, o) {
          var t;
          return (
            (t = goog.isFunction(g.getJobStatus)
            ...
            new dymo.label.framework.PrintJobStatusInfo(
              e,
              o,
              t.status,
              t.statusMessage
    ...
    if ("ActiveXObject" in window) {
      ...
      (o.getPrinters = function () {
        ...
        (o.getJobStatus = function (e, o) {
          var t;
          return (
            (t = goog.isFunction(n.GetJobStatus)
              ? dymo.label.framework.PrintJobStatusInfo.parse(
      ...
      o = {
        ...
        getJobStatus: function (e, o) {
          var t;
          return (
            (t = goog.isFunction(i.getJobStatus)
              ? dymo.label.framework.PrintJobStatusInfo.parse(
      ...
      if (
        ...
        traceMsg(
          "chooseEnvironment > safariPlugin : " +
            !!(a = _findPlugin("application/x-dymolabel")
      ...
      o = {
        ...
        getJobStatus: function (e, o) {
          var t;
          return (
            (t = goog.isFunction(a.getJobStatus)
              ? dymo.label.framework.PrintJobStatusInfo.parse(
                  a.getJobStatus(e, parseInt(o, 10))
                )
              : {
                  status: dymo.label.framework.PrintJobStatus.Unknown,
                  statusMessage: "not implemented",
    ...
    return (
      (o.getPrintersAsync = t(o.getPrinters)),
...
(dymo.label.framework.init = function (e) {
  ...
  (dymo.label.framework.PrintJob.prototype.getStatusForNetworkPrinter =
    function (t) {
      ...
      new goog.net.Jsonp(
        goog.Uri.resolve(o, "getPrintJobStatus"),
        "callback"
      ).send(
        { jobId: g, printerName: this._printerInfo.originalPrinterName },
        function (e) {
          var o = new dymo.label.framework.PrintJobStatusInfo(
            r,
            g,
            e.status,
            e.statusMessage
        ...
        if (-1 != e.indexOf("Win"))
          ...
          if (
            ...
            traceMsg("checkLegacyPlugins > safariPluginFound"),
              "2.0" <= (o = _createSafariPlugin()).GetAPIVersion()
                ? (g.isFrameworkInstalled = !0)
                : (g.errorDetails =
            ...
            traceMsg("checkLegacyPlugins > 'application/x-npapi-dymolabel'"),
              (o = _createMacNsapiPlugin()) && o.getPrinters
                ? (g.isFrameworkInstalled = !0)
                : (g.errorDetails =
        ...
        ? (traceMsg("checkEnvironment > return existing instance of framework"),
          2 == dymo.label.framework.currentFramework
            ...
            : ((g.isBrowserSupported = !0),
              ...
              e && e(g)))
        : o
        ? asyncFindWebService(t, r)
        : syncCheckWebService(t, r),
      g
    );
  });
...
function getPrinters(e) {
  ...
  for (t = 0; t < d.length; t++) {
    (r = o(d[t], "Name")),
      ...
      addPrinterToCollection(
        new dymo.label.framework.LabelWriterPrinterInfo(r, g, n, i, a),
        u
      );
  }
  ...
  for (t = 0; t < m.length; t++) {
    (r = o(m[t], "Name")),
      ...
      addPrinterToCollection(
        new dymo.label.framework.TapePrinterInfo(r, g, n, i, s),
        u
      );
  }
  ...
  for (t = 0; t < p.length; t++) {
    (r = o(p[t], "Name")),
      ...
      addPrinterToCollection(
        new dymo.label.framework.DZPrinterInfo(r, g, n, i, s),
        u
      );
  }
  return u;
          ...
          function (e) {
            ...
            t.setLevel(goog.debug.Logger.Level.INFO),
              0 == o
                ? -1 != r
                  ? s(++r, 0)
                  : t.info("Finished sending job payload for " + n)
                : -5 == o
                ? g < 10
                  ? s(++e.lastAckChunkId, ++g)
                  : t.warning(
...
(NetworkPrinterInfo.prototype.getPrinters = function () {
  ...
  (dymo.label.framework.addPrinterUri = function (t, e, r, o) {
    ...
    new goog.net.Jsonp(i, "callback").send(
      null,
      function (e) {
      ...
      dymo.label.framework.getPrintersAsync().then(function (e) {
        ...
        if (goog.isDefAndNotNull(o))
          return ASSUME_MOBILE || o.isNetworkPrinter()
            ...
            : _createFramework().printLabelAsync(o.name, r, g, n);
